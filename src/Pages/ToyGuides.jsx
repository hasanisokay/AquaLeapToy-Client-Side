...
const ToyGuides = () => {
    return (
        <div className='my-6 mx-10'>
            <h1 className='font-semibold text-2xl text-transparent text-center bg-clip-text bg-gradient-to-r from-slate-600 via-gray-600 to-[#1c0c0b]'>Toy Guides and Recommendations</h1>
